...
<body>
	...
	foreach($a["19002"] as $result => $resultat) //On bouge le curseur sur le groupe 19002.
	{
	...
	$resultat = count($abis); //On compte le nombre de valeur du tableau généré si dessus.
